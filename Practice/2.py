...
# groups of like items are removed from the board. In this problem, 
# any sequence of 3 or more like items should be removed and any items adjacent to that sequence 
# should now be considered adjacent to each other. This process should be repeated as many time as possible.
